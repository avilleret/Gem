...
#ifndef _INCLUDE__GEM_PIXES_PIX_TEXOUT_H_
#define _INCLUDE__GEM_PIXES_PIX_TEXOUT_H_
...
/*-----------------------------------------------------------------
  ...
  -----------------------------------------------------------------*/
class GEM_EXTERN pix_texout : public GemBase
{
  CPPEXTERN_HEADER(pix_texout, GemBase);

    public:

  //////////
  // Constructor
  pix_texout(int, t_atom*);
 ...
 protected:
  ...
  // Set the driver architecture; (probably this makes only sense under linux right now: you can choose between texout4linux(0) and texout1394(1))
  ...
  gem::plugins::texout *m_texoutHandle;
  std::vector<std::string>m_ids;
  std::vector<gem::plugins::texout*>m_texoutHandles;
