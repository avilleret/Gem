...
#ifndef _INCLUDE__GEM_PIXES_PIX_TEXIN_H_
#define _INCLUDE__GEM_PIXES_PIX_TEXIN_H_
...
/*-----------------------------------------------------------------
  ...
  -----------------------------------------------------------------*/
class GEM_EXTERN pix_texin : public GemBase
{
  CPPEXTERN_HEADER(pix_texin, GemBase);

    public:

  //////////
  // Constructor
  pix_texin(int, t_atom*);
 ...
 protected:
  ...
  // Set the driver architecture; (probably this makes only sense under linux right now: you can choose between texin4linux(0) and texin1394(1))
  ...
  gem::plugins::texin *m_texinHandle;
  std::vector<std::string>m_ids;
  std::vector<gem::plugins::texin*>m_texinHandles;
