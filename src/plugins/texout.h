...
Base Class for Texture input Plugins
...
#ifndef _INCLUDE__GEM_PLUGINS_TEXOUT_H_
#define _INCLUDE__GEM_PLUGINS_TEXOUT_H_
...
/*-----------------------------------------------------------------
  ...
  a OS-indendent interface for texture input (for camera, hardware decoder...)
...
namespace gem { namespace plugins {
    ...
    public:
      ...
      // PluginFactory
      static texout*getInstance(void);
